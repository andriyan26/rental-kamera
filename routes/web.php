...
Route::middleware(['auth','admin'])->group(function () {
    ...
    // Admin Invoice Download & Preview
    Route::get('/admin/invoice/{id}/download',[InvoiceController::class,'download'])->name('admin.invoice.download');
    Route::get('/admin/invoice/{id}/preview',[InvoiceController::class,'preview'])->name('admin.invoice.preview');
    ...
    Route::get('/admin/kontrak-penyewa',[LoanContractController::class,'adminIndex'])->name('admin.kontrak.index');
    Route::get('/admin/kontrak-penyewa/{user}/edit',[LoanContractController::class,'adminEdit'])->name('admin.kontrak.edit');
    Route::patch('/admin/kontrak-penyewa/{user}',[LoanContractController::class,'adminUpdate'])->name('admin.kontrak.update');
});
...
Route::middleware('auth')->group(function() {
    ...
    // Midtrans notification callback (set di dashboard Midtrans)
    ...
    Route::get('/memberarea/kontrak',[LoanContractController::class,'memberShow'])->name('member.kontrak');
});
